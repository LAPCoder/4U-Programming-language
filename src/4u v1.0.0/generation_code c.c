...
void debut_code_c(){
	fprintf(fichier, "/* FILE GENERATED BY THE 4U COMPILATOR */\n\n");
...
void genere_code_c(GNode* ast){
	if(ast){
		switch((long)ast->data){
			case SEQUENCE:
				genere_code_c(g_node_nth_child(ast,0));
				genere_code_c(g_node_nth_child(ast,1));
				break;
			case VARIABLE:
			...
			case DANSII:
				...
				genere_code_c(g_node_nth_child(ast,0));
				fprintf(fichier,"<=");
				genere_code_c(g_node_nth_child(ast,2));
				break;
			case DANSEI:
				genere_code_c(g_node_nth_child(ast,0));
				fprintf(fichier,">");
			...
			case BOUCLE_FOR:
				...
				fprintf(fichier,"){\n");
				nb_boucle++;
				genere_code_c(g_node_nth_child(ast,3));
				fprintf(fichier,"\t}\n");
				break;
			case BOUCLE_WHILE:
			...
			case AFFECTATIONNT:
				...
				fprintf(fichier,"\tprintf(\"\\033[31m\\033[01mERREUR\\033[0m d'allocation memoire sur la variable ");
				genere_code_c(g_node_nth_child(ast,0));
				fprintf(fichier," !\");\n\texit(-1);\n\t}\n\tstrcpy(");
				genere_code_c(g_node_nth_child(ast,0));
				fprintf(fichier,",");
